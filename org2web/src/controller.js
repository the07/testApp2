...
module.exports = (function() {
  return{
    ...
    add_record: function(req, res){
      console.log("submit creating record: ");
      ...
      Fabric_Client.newDefaultKeyValueStore({ path: store_path
        ...
        if (user_from_store && user_from_store.isEnrolled()) {
		    ...
		    // createRecord - requires 5 args, ID, vessel, location, timestamp,holder - ex: args: ['10', 'Hound', '-12.021, 28.012', '1504054225', 'Hansel'],
		    // send proposal to endorser
		    const request = {
		        //targets : --- letting this default to the peers assigned to the channel
		        chaincodeId: 'peoplechain',
		        fcn: 'createRecord',
		        args: [key, user, timestamp, organization, status],
		        chainId: 'mychannel',
		        txId: tx_id
		    };
